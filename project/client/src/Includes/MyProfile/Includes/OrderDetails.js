...
const OrderDetails = (props) => {
  ...
  let [deleteCancelOrder, setDeleteCancelOrder] = useState({
    loading: false,
    success: false,
    data: {},
  });
        ...
        <>
          <div className="ship-to">
            ...
            <div className="shipping-address">
              {orderDetails.shipto.addressDetail}, {orderDetails.shipto.ward.WardName},{" "}
              {orderDetails.shipto.district.DistrictName}, {orderDetails.shipto.province.ProvinceName}
            </div>
          ...
          <div className="total-summary">
            ...
            <div className="summary-detail">
              ...
              <div className="sum-value">
                {orderDetails.payment.transactionCode}
              </div>
            </div>
            <div className="summary-detail">
              <div className="title">Ordered Date</div>
              <div className="sum-value">
                {moment(orderDetails.updatedAt).format("YYYY/MM/DD hh:mm A")}
              </div>
            </div>
            <div className="summary-detail">
              <div className="title">Is Paid</div>
              <div className="sum-value">
                {orderDetails.isPaid ? "Yes" : "No"}
              </div>
            </div>
            <div className="summary-detail">
              ...
              <Timeline>
                {orderDetails.status.activeDate && (
                  <Timeline.Item color="blue">
                    ...
                    <p>
                      {moment(orderDetails.status.activeDate).format(
                        "YYYY/MM/DD hh:mm A"
                      )}
                    </p>
                  </Timeline.Item>
                ...
                {orderDetails.status.approvedDate && (
                  <Timeline.Item color="green">
                    ...
                    <p>
                      {moment(orderDetails.status.approvedDate).format(
                        "YYYY/MM/DD hh:mm A"
                      )}
                    </p>
                  </Timeline.Item>
                ...
                {orderDetails.status.cancelledDetail.cancelledDate && (
                  <Timeline.Item color="gray">
                    ...
                    <p>
                      Remark:{" "}
                      {orderDetails.status.cancelledDetail.remark.comment}
                    </p>
                    <p>
                      {moment(
                        orderDetails.status.cancelledDetail.cancelledDate
                ...
                {orderDetails.status.completedDate && (
                  <Timeline.Item color="gray">
                    ...
                    <p>
                      {moment(orderDetails.status.completedDate).format(
                        "YYYY/MM/DD hh:mm A"
                      )}
                    </p>
                  </Timeline.Item>
                ...
                {orderDetails.status.returnedDetail.returnedDate && (
                  <Timeline.Item color="gray">
                    ...
                    <p>
                      Remark:{" "}
                      {orderDetails.status.dispatchedDetail.remark?.comment}
                    </p>
                    <p>
                      {moment(
                        orderDetails.status.dispatchedDetail.returnedDate
                      ).format("YYYY/MM/DD hh:mm A")}
                    </p>
                  </Timeline.Item>
                )}
          ...
          <div className="total-summary">
            ...
            <div className="summary-detail">
              ...
              <div className="sum-value">
                {orderDetails.payment.shippingCharge}
              </div>
            </div>
            <div className="summary-detail">
          ...
          <div className="order-btns">
            <Button className="primary">
              <Link href={`/products/${orderDetails.product.slug}`}>
                <a target="_blank">View Product Detail</a>
              </Link>
            </Button>
              ...
              >
                ...
                <Form.Item>
                  <div className="cancel-create">
                    <Button
                      disabled={deleteCancelOrder.loading}
                      htmlType="submit"
                      className="primary cancel-submit"
                    >
                      Submit
                    </Button>
