...
const forgotPassword = (props) => {
  ...
  const onFinish = (values) => {
    ...
    dispatch(
      actions.sendResendPasswordLink(
        body,
        forgotPasswordState,
  ...
  const onFinishNewPass = (values) => {
    ...
    dispatch(
      actions.resetMyPassword(body, resetPasswordState, setResetPasswordState)
    );
  };
  ...
  if (queryToken) {
    try {
      tokenVerfied = jwt.verify(
        queryToken,
        process.env.NEXT_PUBLIC_JWT_EMAIL_VERIFICATION_KEY
      );
    } catch (error) {
            ...
            <div className="login-title">
              ...
              <p>
                {tokenVerfied
                  ...
                  : "Please enter your to email to reset your password."}
              </p>
            </div>
            {tokenVerfied ? (
