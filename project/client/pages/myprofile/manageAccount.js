...
import RecentOrders from "../../src/Includes/MyProfile/Includes/RecentOrders";
      ...
      <div className="menu-details">
        ...
        <StickyContainer>
          <Tabs defaultActiveKey="1" renderTabBar={renderTabBar}>
            <TabPane tab="My Profile" key="1" className="tab-item">
              <ProfileDetails userData={userData} activeLoc={activeLoc} />
            </TabPane>
            <TabPane tab="My Address" key="2" className="tab-item">
              <AddressDetails
                userData={userData}
                allAddress={userData.location}
              />
            </TabPane>
            <TabPane tab="Recent Orders" key="3" className="tab-item">
              <RecentOrders />
            </TabPane>
          </Tabs>
        </StickyContainer>
