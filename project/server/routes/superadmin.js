...
router.patch(
  "/flip-admin-business-approval/:b_id",
  auth,
  isSuperAdmin,
  flipAdminBusinessApproval
);
router.patch(
  "/flip-admin-bank-approval/:bank_id",
  auth,
  isSuperAdmin,
  flipAdminBankApproval
);
router.patch(
  "/flip-admin-warehouse-approval/:w_id",
  auth,
  isSuperAdmin,
  flipAdminWarehouseApproval
);
router.patch(
  "/flip-admin-account-approval/:a_id",
  auth,
  isSuperAdmin,
  flipAdminAccountApproval
);
...
router.patch(
  "/block-unblock-dispatcher/:dispatcher_id",
  auth,
  isSuperAdmin,
  blockUnbolckDispatcher
);
...
router.put(
  "/disapprove-product/:p_slug",
  auth,
  isSuperAdmin,
  disApproveProduct
);
router.put(
  "/featured-product/:p_slug",
  auth,
  isSuperAdmin,
  toggleProductFeatured
);
