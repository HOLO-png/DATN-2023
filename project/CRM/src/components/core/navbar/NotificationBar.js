...
const NotificationBar = ({
  ...
  const renderNotification = (notificationObj) => {
    const { notificationType, notificationDetail, hasRead, date, _id } =
      notificationObj;
            ...
            <div className={`row no-gutters align-items-center `}>
              ...
              <div className="col-10">
                ...
                <div className="text-muted small mt-1">
                  <strong>{notificationDetail.questionBy} </strong>has asked a
                  question on product{" "}
                  <strong>{notificationDetail.onProduct}</strong>
                </div>
                <div className="text-muted small mt-1">
                  {moment(date).fromNow()}
                </div>
      ...
      >
        <div className="position-relative">
          ...
          {numberOfNotifications > 0 ? (
            <span className="indicator">{numberOfNotifications}</span>
          ) : null}
        </div>
      </Link>
      <div
